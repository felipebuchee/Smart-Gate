...
<body>
    ...
    <main>
        ...
        <a href="cadastroFuncionario.php"><button type="button" class="btn btn-danger">CADASTRAR FUNC</button></a>
        <a href="cadastroAluno.php"><button type="button" class="btn btn-danger">CADASTRAR ALUNO</button></a>
    </main>
